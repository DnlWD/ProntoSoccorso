...
$.getJSON(URL, function (data) {
    ...
    //cicle for write data
    $.each(data.result.records, function (key, value) {
        $('#graph').append('<div class="row"><div class="col name">' + value.ISTITUTO + '</div><div class="col base"></div><div class="col value" style="width:' + value.TUTTI * 5 + 'px">' + value.TUTTI + '</div></div>')
